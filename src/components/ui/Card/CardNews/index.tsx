    ...
    >
      <div className="flex flex-row gap-3 items-center">
        ...
        <div className="flex-grow">
          {/* Judul */}
          <h2 className="text-sm lg:text-base font-semibold leading-snug line-clamp-3 group-hover:text-blue-400 transition-colors duration-200">
            {title}
          </h2>
          {/* Metadata Kecil */}
  ...
  return (
    ...
    >
      <div className="w-full flex flex-row items-center gap-4 py-2 px-2 border-b border-gray-100">
        ...
        {/* Judul Berita (W-4/5) */}
        <div className="">
          <h3 className="text-xs lg:text-base font-semibold leading-tight line-clamp-3 text-gray-800 transition-colors duration-200 group-hover:text-blue-400">
            {title}
          </h3>
        </div>
      </div>
